...
#include "initial_pose_factor.h"
#include <Eigen/Dense>
#include "../utility/utility.h"


InitialPoseFactor::InitialPoseFactor(const Eigen::Vector3d &_P, const Eigen::Quaterniond &_Q)
{
	init_P = _P;
	init_Q = _Q;
...
void InitialPoseFactor::check(double **parameters)
{
